...
function NewsAndBlogs({ data, animationConfig }) {
    ...
    return (
        <Section className='h-[55rem] bg-gradient-to-r from-gray-900  to-gray-600'>
            ...
            <Carourcel className='flex justify-end lg:mt-28' {...animationConfig}>
                    ...
                    {data.map((data, index) => (
                        ...
                        >
                            <Card className='lg:w-[45rem] w-[19rem] lg:h-[27rem] bg-gray-900 lg:grid lg:grid-cols-[20rem,1fr]' style={{ borderRadius: '2rem' }}>
                                ...
                                <div className='mx-10 mt-4 lg:mt-10 grid grid-rows-[78px,50px,170px,20px] lg:grid-rows-[95px,70px,170px,1fr]'>
