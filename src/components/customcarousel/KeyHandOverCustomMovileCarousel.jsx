...
const KeyHandOverCustomMovileCarousel = ({ data }) => {
    console.log(data);
  ...
  return (
    <Section className="lg:hidden block">
      <Main className={`grid ${data[activeImageIndex]?.name? "grid-rows-[1fr,2rem,8rem,2rem]" : "grid-rows-[1fr,8rem,2rem]"} bg-gray-900 bg-opacity-90 rounded-[1.1rem] p-5 gap-5`}>
        <SliderContainer>
...
export default KeyHandOverCustomMovileCarousel;
